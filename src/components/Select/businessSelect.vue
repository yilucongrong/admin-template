<template>
    ...
    <el-select size="small"
        ...
        <el-option v-for="item in options"
                   :key="item[showField[0]]"
                   :label="item[showField[1]]"
...
export default {
    ...
    props: {
        filterKey: {
            //过滤条件字段'businessFunction',
            type: String,
            default: ""
        },
        filterValue: {
            //过滤条件值"dt_org_function_rd",
            type: String,
            default: ""
        },
        selectType: {
            //查询业务，对应store/modules/businessComponent.js 业务类型名称
            type: String
        },
        showField: {
            //显示的字段['organizationCode','organizationName']
            type: Array
        },
        disabled: {
            type: Boolean,

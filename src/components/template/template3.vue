    ...
    <div>
        ...
        <el-dialog custom-class="dialog-custom"
            ...
            <el-form class="small-space"
                ...
                <el-form-item :label="$t('dict.dictCode')"
                              prop="dictCode">
                ...
                <el-form-item :label="$t('dict.dictItemDTOs')">
                    <div style="max-height: 100px; overflow-y: scroll">
                        <div style="padding-bottom: 5px"
                             v-for="item in temp.dictItemDTOs"
                             :key="item.key">
                            <el-input v-model="item.dictItemKey"
                                      style="width: 150px"
                                      :placeholder="$t('dict.dictItemKey')"></el-input>
                            <el-input v-model="item.dictItemValue"
                                      style="width: 150px"
                    ...
                    <el-button type="primary"
                               @click="addDictItem">{{$t('table.addDictItem')}}</el-button>
                </el-form-item>
            </el-form>
            <div slot="footer"
                 class="dialog-footer">
...
export default {
    ...
    methods: {
        ...
        selectRow2 (val) {//表一单击行选中方法
            ...
            console.log(this.selectlistRow2, '888')
            this.$refs.tb.clearSelection();
        ...
        handleUpdate1 () {//明细编辑弹窗
            ...
            if (this.selectlistRow1 && this.selectlistRow1.length == 1) {
                this.readonly = true; //员工编码不可以编写
                console.log(this.selectlistRow2, '9999')

    ...
    <el-row>
        ...
        <el-col :span="21">
            <div class="app-container">
                    ...
                    <div class="main-header">
                        <div class="select-content">
                            ...
                            <el-input
                                ...
                                @keyup.enter.native="handleFilter"
                            />
                            <el-checkbox v-model="listQuery.scope"
                                >全部</el-checkbox
                            >
                            &nbsp;&nbsp;&nbsp;
                            <el-button
                ...
                <!-- 用户维护弹窗 -->
                <el-dialog
                    :title="$t('employeesManagement.userMaintain')"
                ...
                >
                    ...
                    >
                        ...
                        <el-form-item
                            :label="$t('employeesManagement.password')"
                            prop="password"
                        >
                        ...
                        <el-form-item
                            ...
                            prop="isLog"
                        >
                            <el-radio v-model="temp.isLog" :label="0">{{
                                $t("table.close")
                            }}</el-radio>
                            <el-radio v-model="temp.isLog" :label="1">{{
                                $t("table.open")
                            }}</el-radio>
                        </el-form-item>
                        <el-form-item
                            ...
                            prop="state"
                        >
                            <el-radio v-model="temp.state" :label="0">{{
                                $t("table.close")
                            }}</el-radio>
                            <el-radio v-model="temp.state" :label="1">{{
                                $t("table.open")
                            }}</el-radio>
                        </el-form-item>
                        <el-button type="primary" @click="handadduser">{{
                            $t("table.add")
                        }}</el-button>
                    </el-form>
                    <div class="btn">

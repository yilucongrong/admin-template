            ...
            <el-col :span="21">
                <div class="app-container">
                    ...
                    <el-dialog width="40%"
                               top="10vh"
                               custom-class="dialog-custom"
                               :title="dialogStatus == 'create'? '确定要挂起选择的流程实例吗?请输入意见': '确定要停止选择的流程实例吗?请输入意见'"
                               :close-on-click-modal="false"
                               :visible.sync="dialogVisiblesearch">
                        <textarea style="margin-left:20px"
                                  :cols="70"
                                  :rows="10"></textarea>
                        <div slot="footer"
                             class="dialog-footer">
...
export default {
    name: "processDesign",
    components: { changeModuleSelect, Pagination, replace },
    data () {
        return {
            modalnum: null,//模板编号
            theight: 0,//表格高度

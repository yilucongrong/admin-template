                ...
                <el-dialog custom-class="dialog-custom"
                    ...
                    <el-form class="small-space"
                        ...
                        <el-form-item label="设备类型编码"
                                      prop="equipTypeCode">
                            <el-input v-model="temp.equipTypeCode"
                                      :disabled="dialogStatus != 'create'"></el-input>
                        </el-form-item>
                        <el-form-item label="设备分类名称"
                                      prop="equipTypeName">
                            <el-input v-model="temp.equipTypeName"></el-input>
                        </el-form-item>
    ...
    methods: {
        ...
        handleUpdate () {
            ...
            if (this.selectedRows && this.selectedRows.length == 1) {
                ...
                api.getRecord(this.temp.equipTypeCode).then(res => {
                    this.temp = res.data;
        ...
        update () {
            ...
            this.$refs["temp"].validate(valid => {
                if (valid) {
                    api.updataRecord(this.temp.equipTypeCode, this.temp).then(() => {
                        this.getList();
                        this.dialogFormVisible = false;
                        this.$message({
                            title: "成功",
        ...
        handleDelete () {
            ...
            if (this.selectedRows && this.selectedRows.length == 1) {
                this.$confirm("此操作将永久删除该文件, 是否继续?", "提示", {
                    ...
                    let equipTypeCodeList = [];
                    this.selectedRows.forEach((val, index) => {
                        equipTypeCodeList[index] = val.equipTypeCode;
                    });
                    api.deleteRecord(equipTypeCodeList).then(() => {
                        this.getList(),
                            this.$message({
                                title: "成功",
                                message: "删除成功",

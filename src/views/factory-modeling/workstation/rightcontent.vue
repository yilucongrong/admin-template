    ...
    <div class="app-container calendar-list-container">
        <div class="filter-container">
            <div class="filter-items">
                <div class="select-element">
                    <el-input size="small" :placeholder="$t('workstation.stationCode')" v-model="listQuery.stationCode" class="filter-item" @keyup.enter.native="handleQuery"/>
                    <el-input size="small" :placeholder="$t('workstation.stationName')" v-model="listQuery.stationName" class="filter-item" @keyup.enter.native="handleQuery"/>
        ...
        <div class="table-container">
            ...
            <el-table
                ...
                <el-table-column show-overflow-tooltip width="120" align="left" :label="$t('workstation.lineCode')" prop="lineCode"></el-table-column>
                <el-table-column show-overflow-tooltip width="120" align="left" :label="$t('workstation.lineName')" prop="lineName"></el-table-column>
                <el-table-column show-overflow-tooltip width="120" align="left" :label="$t('workstation.stationCode')" prop="stationCode"></el-table-column>
                <el-table-column show-overflow-tooltip width="120" align="left" :label="$t('workstation.stationName')" prop="stationName"></el-table-column>
                <el-table-column show-overflow-tooltip width="120" align="left" :label="$t('workstation.stationNo')" prop="stationNo"></el-table-column>
                <el-table-column show-overflow-tooltip width="120" align="left" :label="$t('workstation.stationType')" prop="stationType"></el-table-column>
                <el-table-column show-overflow-tooltip width="120" align="left" :label="$t('workstation.stationTypeName')" prop="stationTypeName"></el-table-column>
                <el-table-column show-overflow-tooltip min-width="100" align="left" :label="$t('workstation.feedArea')" prop="feedArea"></el-table-column>
            </el-table>
            <pagination
                :total="total"
        ...
        <el-dialog
            ...
            <el-form
                ...
                <el-form-item :label="$t('workstation.lineCode')" prop="lineCode">
                    <el-input v-model="temp.lineCode" disabled></el-input>
                </el-form-item>
                <el-form-item :label="$t('workstation.stationCode')" prop="stationCode">
                    <el-input v-model="temp.stationCode"></el-input>
                </el-form-item>
                <el-form-item :label="$t('workstation.stationName')" prop="stationName">
                    <el-input v-model="temp.stationName"></el-input>
                </el-form-item>
                <el-form-item :label="$t('workstation.stationNo')" prop="stationNo">
                    <el-input v-model="temp.stationNo"></el-input>
                </el-form-item>
                <el-form-item :label="$t('workstation.stationType')" prop="stationType">
                    <el-select size="small" v-model="temp.stationType" :placeholder="$t('table.select')">
                        <el-option
                            v-for="item in dt_station_type"
                ...
                <el-form-item :label="$t('workstation.feedArea')" prop="feedArea">
                    <el-input style="width: 165px" v-model="temp.feedArea" disabled>
                        <el-button slot="append" icon="el-icon-search" @click="handlefeed"></el-button>
                    </el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog
            ...
            v-dialogDrag
            :close-on-click-modal="false">
            <tkqy :warehouseCode="feedArea" @handSelectAreasRows="feedAreas"></tkqy>
            <div slot="footer" class="dialog-footer">
                <el-button type="primary" @click="update3">{{$t('table.confirm')}}</el-button>
            </div>
        </el-dialog>
    </div>
</template>
...
<script>
    ...
    export default {
        components: { Pagination, warehouseSelect, orgSelect, tkqy },
        data() {
            return {
                list: null,
                total: 0,
        ...
        methods: {
            ...
            handleUpdate() {//编辑弹窗
                ...
                if (this.selectlistRow && this.selectlistRow.length == 1) {
                    ...
                    api.queryJob(this.temp.workCenterCode, this.temp.stationCode).then(res => {
                        this.temp = res.data;
            ...
            update() { //编辑
                this.$refs["temp"].validate(valid => {
                    if (valid) {
                    api.updateJob(this.workCenterCode, this.temp.stationCode, this.temp).then(() => {
                        this.getList1();
            ...
            handleDelete() {//删除列表
                if (this.selectlistRow && this.selectlistRow.length == 1) {
                    this.$confirm("此操作将删除所选中数据, 是否继续?", "提示", {
                        ...
                        api.deleteJob(this.workCenterCode, ids).then(response => {
                            this.getList1(),
                                this.$message({
                                title: "成功",
                                message: "删除成功",
            ...
            create() {
                this.$refs.temp.validate(valid => {
                    if (valid) {
                        api.creatJob(this.temp.workCenterCode, this.temp).then(res => {
                            this.getList1();
                            this.dialogFormVisible = false;
                            this.$notify({
                                title: "成功",
